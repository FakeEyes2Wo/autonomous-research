...
更新日期：2026-09-09。状态：配置适配、安装器和本地契约测试已实施；真实 CPA 端点模型请求仍待用户配置验收。流程与模型策略见[研究运行草稿](research-runtime.md)，实施顺序见[草稿索引](README.md)，总体验收见[当前状态](../verification/current-status.md)。
